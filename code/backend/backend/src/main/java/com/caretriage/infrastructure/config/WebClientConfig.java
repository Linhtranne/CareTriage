...
public class WebClientConfig {
    ...
    @Bean
    public WebClient aiServiceSseWebClient(WebClient.Builder builder) {
        HttpClient httpClient = HttpClient.create()
                .option(ChannelOption.CONNECT_TIMEOUT_MILLIS, connectTimeoutMs)
                .responseTimeout(Duration.ofMinutes(10)) // Long timeout for SSE
                .doOnConnected(conn -> conn
                        .addHandlerLast(new ReadTimeoutHandler(600))); // 10 minutes
