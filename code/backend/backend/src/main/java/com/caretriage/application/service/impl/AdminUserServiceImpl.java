...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    public AdminUserResponse updateUserProfile(Long userId, AdminUserResponse request) {
        ...
        if (roles.contains("ROLE_PATIENT")) {
            ...
            if (profile == null) {
                profile = PatientProfile.builder().user(com.caretriage.infrastructure.persistence.mapper.UserMapper.INSTANCE.toEntity(user)).build();
            }
        ...
        if (roles.contains("ROLE_DOCTOR")) {
            ...
            if (profile == null) {
                profile = DoctorProfile.builder().user(com.caretriage.infrastructure.persistence.mapper.UserMapper.INSTANCE.toEntity(user)).build();
            }
