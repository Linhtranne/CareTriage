...
public class ChatSessionController {
    ...
    private final com.caretriage.application.service.AiClientService aiClientService;
    ...
    public ResponseEntity<com.caretriage.application.dto.ChatSessionDTO> createSession(
    ...
    public ResponseEntity<Map<String, Object>> completeTriage(
        ...
        Map<String, Object> result = chatService.completeTriage(user.getId(), sessionId, forceSubmit);
