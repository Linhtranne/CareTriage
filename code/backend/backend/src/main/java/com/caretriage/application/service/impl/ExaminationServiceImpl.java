...
import com.caretriage.application.service.ExaminationService;
...
public class ExaminationServiceImpl implements ExaminationService {
    ...
    public AppointmentResponse startExamination(Long appointmentId, String doctorEmail) {
        ...
        User patient = com.caretriage.infrastructure.persistence.mapper.UserMapper.INSTANCE.toDomain(appointment.getPatient());
        if (patient.getPatientProfile() == null) {
            log.info("Tạo mới hồ sơ bệnh án cơ bản cho bệnh nhân ID: {}", patient.getId());
            PatientProfile profile = PatientProfile.builder()
                    .user(com.caretriage.infrastructure.persistence.mapper.UserMapper.INSTANCE.toEntity(patient))
                    .build();
