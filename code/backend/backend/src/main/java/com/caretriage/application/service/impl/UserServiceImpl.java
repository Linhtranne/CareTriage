...
import com.caretriage.domain.entity.PatientProfile;
...
import com.caretriage.domain.repository.PatientProfileRepository;
import com.caretriage.domain.repository.UserRepository;
import com.caretriage.application.service.UserService;
    ...
    public UserProfileResponse updateProfile(String email, UpdateProfileRequest request) {
        ...
        if (isDoctor) {
            DoctorProfile profile = doctorProfileRepository.findByUserId(user.getId())
                    .orElseGet(() -> DoctorProfile.builder().user(com.caretriage.infrastructure.persistence.mapper.UserMapper.INSTANCE.toEntity(user)).build());
            ...
            PatientProfile profile = patientProfileRepository.findByUserId(user.getId())
                    .orElseGet(() -> PatientProfile.builder().user(com.caretriage.infrastructure.persistence.mapper.UserMapper.INSTANCE.toEntity(user)).build());
