...
public class AppointmentServiceTest {
    ...
    @Mock
    private com.caretriage.repository.ChatSessionRepository chatSessionRepository;
    @Mock
    ...
    void createAppointmentFromTicket_Success() {
        ...
        doctor.setId(2L);
        doctor.setFullName("Doctor One");
        com.caretriage.entity.Role doctorRole = new com.caretriage.entity.Role();
        doctorRole.setName("DOCTOR");
        doctor.setRoles(java.util.Collections.singleton(doctorRole));

        com.caretriage.entity.TriageTicket ticket = com.caretriage.entity.TriageTicket.builder()
                .id(java.util.UUID.randomUUID())
                .ticketNumber("TRIAGE-1")
                .description("Sore throat")
                .requester(patient)
                .doctorReviewStatus(com.caretriage.entity.TriageTicket.DoctorReviewStatus.DOCTOR_CONFIRMED)
                .build();

        com.caretriage.dto.request.CreateAppointmentFromTicketRequest request = new com.caretriage.dto.request.CreateAppointmentFromTicketRequest();
        ...
        com.caretriage.entity.DoctorSchedule schedule = new com.caretriage.entity.DoctorSchedule();
        ...
        // Assert
        assertNotNull(result);
        assertEquals(com.caretriage.entity.TriageTicket.DoctorReviewStatus.APPOINTMENT_CREATED, ticket.getDoctorReviewStatus());
    ...
    void createAppointmentFromTicket_Success_LocksSession() {
        ...
        com.caretriage.entity.ChatSession session = new com.caretriage.entity.ChatSession();
        session.setId(10L);
        session.setStatus(com.caretriage.entity.ChatSession.SessionStatus.ACTIVE);
        ...
        com.caretriage.entity.TriageTicket ticket = com.caretriage.entity.TriageTicket.builder()
                ...
                .requester(patient)
                .doctorReviewStatus(com.caretriage.entity.TriageTicket.DoctorReviewStatus.DOCTOR_EDITED)
                .chatSession(session)
                .build();
        ...
        assertNotNull(result);
        assertEquals(com.caretriage.entity.TriageTicket.DoctorReviewStatus.APPOINTMENT_CREATED, ticket.getDoctorReviewStatus());
        assertEquals(com.caretriage.entity.ChatSession.SessionStatus.COMPLETED, session.getStatus());
    ...
    void createAppointmentFromTicket_UnreviewedTicket_ThrowsException() {
        ...
        com.caretriage.entity.TriageTicket ticket = com.caretriage.entity.TriageTicket.builder()
                ...
                .requester(patient)
                .doctorReviewStatus(com.caretriage.entity.TriageTicket.DoctorReviewStatus.AI_ANALYSIS_PENDING_REVIEW)
                .build();
    ...
    void createAppointmentFromTicket_NonDoctorNonAdmin_ThrowsAccessDenied() {
        ...
        com.caretriage.entity.Role patientRole = new com.caretriage.entity.Role();
