...
public class DoctorControllerIntegrationTest {
    ...
    public void getDoctorSlots_InvalidDate_Past() throws Exception {
        ...
        when(doctorService.getAvailableSlots(eq(doctorId), eq(date)))
                .thenThrow(new com.caretriage.shared.exception.BusinessException("Không thể xem lịch khám trong quá khứ"));
    ...
    public void getDoctorSlots_DoctorNotFound() throws Exception {
        ...
        when(doctorService.getAvailableSlots(eq(doctorId), eq(date)))
                .thenThrow(new com.caretriage.shared.exception.ResourceNotFoundException("Không tìm thấy bác sĩ với ID: " + doctorId));
