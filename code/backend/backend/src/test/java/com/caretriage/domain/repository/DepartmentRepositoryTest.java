...
import com.caretriage.infrastructure.config.JpaConfig;
...
@org.springframework.data.jpa.repository.config.EnableJpaRepositories(basePackages = "com.caretriage.domain.repository")
