...
public class DepartmentControllerIntegrationTest {
    ...
    public void uploadImage_InvalidMimeType() throws Exception {
        ...
        when(departmentService.uploadImage(any())).thenThrow(new BusinessException("Chỉ chấp nhận định dạng ảnh (JPG, PNG, GIF)"));
    ...
    public void uploadImage_OversizedFile() throws Exception {
        ...
        when(departmentService.uploadImage(any())).thenThrow(new BusinessException("Dung lượng ảnh tối đa là 5MB"));
