...
async def extract_from_text(request: EHRExtractRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal AI service error occurred during extraction")
...
async def extract_from_file(file: UploadFile = File(...)):
    ...
    try:
        ...
        logger.exception("EHR extraction from file failed")
        raise HTTPException(status_code=500, detail="Internal AI service error occurred during file extraction")
