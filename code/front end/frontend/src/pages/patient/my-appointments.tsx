...
export default function MyAppointments() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => fetchAppointments(), 0);
  ...
  return (
    ...
    >
      ...
      >
        <DialogTitle component="div" sx={{ p: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Typography variant="h4" component="span" sx={{ fontWeight: 950, color: 'oklch(20% 0.05 250)', letterSpacing: '-0.04em' }}>
        ...
        <DialogContent sx={{ px: 4, pb: 2 }}>
          ...
          <Box sx={{ p: 4, borderRadius: 6, bgcolor: 'oklch(98% 0.01 250)', border: '1px solid oklch(92% 0.02 250)' }}>
            ...
            {selectedAppt?.triagePriority && (
              <>
                <Divider sx={{ my: 3, borderColor: 'oklch(92% 0.02 250)' }} />
                <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2 }}>
                  <AlertCircle size={20} color="oklch(65% 0.15 40)" />
                  <Typography variant="h6" sx={{ fontWeight: 900, letterSpacing: '-0.02em' }}>{t('records.triage_priority')}</Typography>
                </Stack>
                <Chip 
                  label={
                    selectedAppt.triagePriority === 'URGENT' || selectedAppt.triagePriority === 'CRITICAL' ? t('triage_tickets.priority_labels.CRITICAL') :
                    selectedAppt.triagePriority === 'HIGH' ? t('triage_tickets.priority_labels.HIGH') :
                    selectedAppt.triagePriority === 'MEDIUM' ? t('triage_tickets.priority_labels.MEDIUM') :
                    t('triage_tickets.priority_labels.LOW')
                  } 
                  size="small" 
                  sx={{ 
                    fontWeight: 700, borderRadius: 2, 
                    bgcolor: selectedAppt.triagePriority === 'URGENT' || selectedAppt.triagePriority === 'CRITICAL' ? 'oklch(96% 0.01 20)' : 'oklch(96% 0.05 250)', 
                    color: selectedAppt.triagePriority === 'URGENT' || selectedAppt.triagePriority === 'CRITICAL' ? 'oklch(60% 0.15 20)' : 'oklch(50% 0.15 250)'
                  }} 
                />
              </>
            )}
      ...
      >
        <DialogTitle component="div" sx={{ pt: 4, textAlign: 'center' }}>
          <Box sx={{ 
          ...
          <Typography variant="h4" component="span" sx={{ fontWeight: 950, color: 'oklch(20% 0.05 250)', letterSpacing: '-0.04em', display: 'block' }}>
