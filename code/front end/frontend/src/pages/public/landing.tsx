  ...
  return (
    <Box
      sx={{
        minHeight: '100vh',
        maxWidth: '100vw',
        background: 'linear-gradient(135deg, var(--color-primary-50) 0%, var(--color-primary-50) 50%, var(--color-surface-50) 100%)',
        color: 'text.primary',
    ...
    >
      ...
      <Box
        sx={{
          ...
          background: 'radial-gradient(circle, color-mix(in srgb, var(--color-primary-500) 15%, transparent) 0%, color-mix(in srgb, var(--color-surface-50) 0%, transparent) 70%)',
        ...
        >
          ...
          <Box sx={{ animation: `${float} 4s ease-in-out infinite`, mb: 3, position: 'relative', zIndex: 1 }}>
            <svg width="90" height="90" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="3" y="3" width="18" height="18" rx="6" fill='primary.main' fillOpacity="0.15" />
              <path d="M12 7V17M7 12H17" stroke='primary.dark' strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </Box>
          ...
          <Typography
            ...
            sx={{
              ...
              color: 'primary.900', letterSpacing: '-1px',
              fontSize: { xs: '2.8rem', md: '4rem' },
              animation: `${slideInLeft} 1s cubic-bezier(0.16, 1, 0.3, 1)`,
            }}
          >
            {t('hero.title')} <br />
            <Box component="span" sx={{ color: 'primary.dark', textShadow: '0 4px 20px color-mix(in srgb, var(--color-primary-500) 15%, transparent)' }}>
              {t('hero.subtitle')}
            </Box>
          </Typography>
          ...
          <Typography
            variant="h6"
            sx={{ color: 'text.secondary', mb: 5, maxWidth: 750, fontWeight: 500, fontSize: '1.2rem' }}
          >
            {t('hero.description')}
          </Typography>
          ...
          <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap', justifyContent: 'center' }}>
            <Button
              ...
              sx={{
                px: 6, py: 2, fontSize: '1.1rem', borderRadius: 1,
                background: 'linear-gradient(135deg, var(--color-primary-500) 0%, var(--color-primary-600) 100%)',
                boxShadow: '0 10px 25px color-mix(in srgb, var(--color-primary-500) 30%, transparent)',
                '&:hover': {
                  transform: 'translateY(-3px) scale(1.02)',
                  boxShadow: '0 15px 30px color-mix(in srgb, var(--color-primary-500) 40%, transparent)',
                },
            ...
            <Button
              ...
              sx={{
                ...
                color: 'primary.800',
                background: 'color-mix(in srgb, var(--color-surface-50) 45%, transparent)',
      ...
      <Reveal>
        <Box id="ai-tech" sx={{
          ...
          <Box sx={{ maxWidth: 1200, mx: 'auto', position: 'relative', zIndex: 1 }}>
            ...
            <Typography variant="h3" sx={{ fontWeight: 900, color: 'primary.900', mb: 3, textAlign: 'center' }}>
              {t('triage.title')}
            </Typography>
            <Typography variant="body1" sx={{ color: 'text.secondary', mb: 6, textAlign: 'center', maxWidth: 800, mx: 'auto', fontSize: '1.1rem' }}>
              ...
              {[
                ...
                <Grid size={{ xs: 12, md: 4 }} key={idx}>
                  <Paper
                    elevation={0}
                    sx={{
                      p: 3.5, borderRadius: 1, textAlign: 'center',
                      background: 'color-mix(in srgb, var(--color-surface-50) 60%, transparent)',
                  ...
                  >
                    <Box sx={{ color: 'primary.dark', display: 'flex', mb: 2 }}>{item.icon}</Box>
            ...
            <Box sx={{ maxWidth: 600, mx: 'auto' }}>
              ...
              >
                ...
                <CardContent sx={{ minHeight: 360, height: 360, overflowY: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', gap: 2.5, p: 3 }}>
                  ...
                  {chatStep >= 0 && (
                    <Paper elevation={0} sx={{ p: 2, alignSelf: 'flex-end', maxWidth: '80%', background: 'primary.dark', color: 'background.paper', borderRadius: '16px 16px 4px 16px', boxShadow: '0 4px 10px rgba(5, 150, 105, 0.15)' }}>
                  ...
                  {chatStep >= 1 && (
                    <Fade in timeout={500}>
                      <Paper elevation={0} sx={{ p: 2, alignSelf: 'flex-start', maxWidth: '85%', background: 'color-mix(in srgb, var(--color-primary-500) 10%, transparent)', border: '1px solid color-mix(in srgb, var(--color-primary-500) 20%, transparent)', color: 'primary.900', borderRadius: '16px 16px 16px 4px' }}>
      ...
      <Reveal>
        <Box id="doctors" sx={{ mt: 8, mb: 4, position: 'relative', width: '100%' }}>
          <Box sx={{ maxWidth: 1200, mx: 'auto', px: 3, position: 'relative', zIndex: 1 }}>
            ...
            <Typography variant="h3" sx={{ fontWeight: 900, color: 'primary.900', mb: 3, textAlign: 'center', position: 'relative', zIndex: 1 }}>
              {t('ehr.title')}
            </Typography>
            <Typography variant="body1" sx={{ color: 'text.secondary', mb: 6, textAlign: 'center', maxWidth: 800, mx: 'auto', fontSize: '1.1rem' }}>
              {t('ehr.description')}
          ...
          <Box
            sx={{
              ...
              '&::before': { left: 0, background: 'linear-gradient(to right, var(--color-primary-50) 0%, color-mix(in srgb, var(--color-surface-50) 0%, transparent) 100%)' },
              '&::after': { right: 0, background: 'linear-gradient(to left, var(--color-primary-50) 0%, color-mix(in srgb, var(--color-surface-50) 0%, transparent) 100%)' }
            }}
          >
            <Box
              sx={{
            ...
            >
              {[...ehrFeatures, ...ehrFeatures].map((item, idx) => (
                ...
                >
                  <Box sx={{ color: 'primary.dark', display: 'flex', mb: 2 }}>
                    {item.icon}
                  </Box>
                  <Typography variant="h6" sx={{ fontWeight: 800, color: 'primary.900', mb: 1 }}>
                    {item.title}
                  </Typography>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', mt: 6, gap: 2.5, flexWrap: 'wrap' }}>
            <Button
              ...
              sx={{
                borderColor: 'primary.dark', color: 'primary.dark', px: 5, py: 1.5, fontSize: '1.05rem',
                borderWidth: '2px',
                '&:hover': {
                  borderColor: 'primary.800',
                  color: 'primary.800',
            ...
            <Button
              ...
              sx={{
                ...
                borderRadius: 3,
                background: 'linear-gradient(135deg, var(--color-primary-500) 0%, var(--color-primary-600) 100%)',
                boxShadow: '0 10px 24px color-mix(in srgb, var(--color-primary-500) 30%, transparent)',
                '&:hover': {
                  transform: 'translateY(-2px)',
                  boxShadow: '0 14px 28px color-mix(in srgb, var(--color-primary-500) 35%, transparent)',
                },
                transition: 'all 0.3s ease',
              }}
            >
          ...
          <Reveal key={idx} delay={idx * 0.1}>
            ...
            >
              ...
              <Box sx={{ flex: 1, px: { xs: 2, md: 4 } }}>
                <Typography variant="h3" sx={{ fontWeight: 900, color: 'primary.900', mb: 3, fontSize: { xs: '2rem', md: '2.8rem' } }}>
                  {item.title}
                </Typography>
                <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.8, fontSize: '1.15rem' }}>
                  {item.description}
                </Typography>
              </Box>
              ...
              <Box
                sx={{
                  ...
                  borderRadius: 5,
                  overflow: 'hidden',
                  background: 'color-mix(in srgb, var(--color-surface-50) 50%, transparent)',
                  backdropFilter: 'blur(16px)',
                  border: '1px solid color-mix(in srgb, var(--color-primary-500) 15%, transparent)',
      ...
      <Reveal>
        <Box
          sx={{
            ...
            background: 'linear-gradient(180deg, var(--color-surface-50) 0%, #fef2f2 100%)',
          ...
          <Box sx={{ maxWidth: 1536, mx: 'auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            ...
            <Grid container spacing={4} sx={{ textAlign: 'left' }}>
              {[
                ...
                <Grid size={{ xs: 12, md: 4 }} key={idx}>
                  <Box sx={{ p: 3, background: 'background.paper', borderRadius: 1, boxShadow: '0 10px 30px rgba(153, 27, 27, 0.03)', border: '1px solid rgba(239, 68, 68, 0.05)' }}>
      ...
      <Reveal>
        <Box
          sx={{
            width: '100%', py: { xs: 8, md: 12 }, px: { xs: 3, md: 6 },
            background: 'linear-gradient(180deg, #fef2f2 0%, var(--color-primary-50) 100%)',
        ...
        >
          ...
          <Box sx={{ maxWidth: 1536, mx: 'auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <Typography variant="h3" sx={{ fontWeight: 900, color: 'primary.800', mb: 4 }}>
              {t('solutions.title')}
            </Typography>
            <Typography variant="h5" sx={{ color: 'primary.800', mb: 6, fontWeight: 600, lineHeight: 1.6, maxWidth: 850, mx: 'auto' }}>
            ...
            <Grid container spacing={4} sx={{ textAlign: 'left' }}>
              {[
                ...
                <Grid size={{ xs: 12, md: 4 }} key={idx}>
                  <Box sx={{ p: 3, background: 'background.paper', borderRadius: 1, boxShadow: '0 10px 30px color-mix(in srgb, var(--color-primary-500) 3%, transparent)', border: '1px solid color-mix(in srgb, var(--color-primary-500) 5%, transparent)' }}>
                    <Typography variant="h6" sx={{ fontWeight: 800, color: 'primary.dark', mb: 1.5 }}>{item.title}</Typography>
                    <Typography variant="body2" sx={{ color: 'primary.800', lineHeight: 1.6 }}>{item.text}</Typography>
                  </Box>
                </Grid>
              ))}
            </Grid>
