...
export default function Clinics() {
  ...
  return (
    <Box sx={{ 
      minHeight: '100vh', 
      bgcolor: 'background.default', // Meadow Mist Ground
      color: 'text.primary',
      overflowX: 'hidden'
    }}>
      <Navbar />
        ...
        <Container maxWidth="xl">
          <Grid container spacing={{ xs: 6, lg: 10 }} alignItems="center">
                ...
                <motion.div variants={fadeUp}>
                  <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3}>
                    <Button 
                      ...
                      disableElevation
                      sx={{ 
                        bgcolor: '#08bba3', color: 'background.paper', px: 6, py: 2.5, borderRadius: '14px',
                    ...
                    <Button 
                      ...
                      sx={{ 
                        borderColor: '#e2e8f0', color: 'text.primary', px: 6, py: 2.5, borderRadius: '14px',
                        fontSize: '1.125rem', fontWeight: 800, textTransform: 'none',
            ...
            <Grid size={{ xs: 12, lg: 5 }} >
              ...
              >
                <Paper sx={{ 
                  p: 2, borderRadius: '32px', bgcolor: 'background.paper',
                  boxShadow: '0 40px 80px rgba(0,0,0,0.05)',
                  border: '1px solid #e2e8f0',
                  position: 'relative'
                }}>
                  <Box sx={{ p: 3, bgcolor: 'background.default', borderRadius: '24px' }}>
                  ...
                  <Paper sx={{ 
                    ...
                    bgcolor: '#08bba3', color: 'background.paper', boxShadow: '0 12px 24px rgba(8, 187, 163, 0.3)',
          ...
          <Grid container spacing={4}>
            ...
            <Grid size={{ xs: 12, md: 4 }} >
              <Paper sx={{ 
                ...
                <Typography variant="h4" sx={{ fontWeight: 900, mb: 2, color: 'primary.900' }}>
              ...
              <Paper sx={{ 
                ...
                <Grid container spacing={6} alignItems="center">
                  <Grid size={{ xs: 12, md: 6 }} >
                    ...
                    <Typography variant="h3" sx={{ fontWeight: 900, mb: 2, color: 'primary.900' }}>
                  ...
                  <Grid size={{ xs: 12, md: 6 }} >
                    <Stack direction="row" spacing={3} justifyContent="center">
                      {[
                        ...
                        <Box key={i} sx={{ px: 3, py: 2, bgcolor: 'background.default', borderRadius: '16px', border: '1px solid #e2e8f0', textAlign: 'center' }}>
      ...
      {/* 3. CTA Footer */}
      <Box sx={{ py: 20, px: 3, background: 'primary.900', color: 'background.paper', textAlign: 'center' }}>
        <Container maxWidth="md">
          ...
          <Button 
            variant="contained" 
            sx={{ 
              bgcolor: 'background.paper', color: 'primary.900', px: 8, py: 2.5, borderRadius: '999px',
