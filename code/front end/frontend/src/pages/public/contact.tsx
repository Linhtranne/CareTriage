      ...
      <Container maxWidth="xl" sx={{ mt: -6, position: 'relative', zIndex: 2 }}>
        <Grid container spacing={4}>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            <Stack spacing={3}>
              <Paper elevation={0} sx={{ p: 4, borderRadius: 2, boxShadow: '0 10px 40px rgba(0,0,0,0.05)' }}>
                <Typography variant="h5" sx={{ fontWeight: 800, color: 'primary.900', mb: 4 }}>Thông tin liên hệ</Typography>
                <Stack spacing={4}>
                ...
                <Stack direction="row" spacing={1}>
                  {[Facebook, Twitter, LinkedIn, Instagram].map((Icon, i) => (
                    <IconButton key={i} sx={{ bgcolor: '#f1f5f9', color: 'primary.900', '&:hover': { bgcolor: 'primary.main', color: 'background.paper' } }}>
                      <Icon />
                    </IconButton>
                  ))}
                </Stack>
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            <Paper elevation={0} sx={{ p: { xs: 4, md: 6 }, borderRadius: 2, boxShadow: '0 20px 60px rgba(0,0,0,0.05)' }}>
              <Typography variant="h4" sx={{ fontWeight: 800, color: 'primary.900', mb: 4 }}>Gửi tin nhắn cho chúng tôi</Typography>
                  ...
                  <Grid size={{ xs: 12 }}>
                    ...
                    <Button 
                      ...
                      sx={{ 
                        ...
                        boxShadow: '0 10px 25px color-mix(in srgb, var(--color-primary-500) 25%, transparent)',
                      }}
                    >
