...
export default function AITriage() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', background: 'background.default', color: 'text.primary', overflowX: 'hidden' }}>
      ...
      <Box sx={{ py: { xs: 16, md: 24 }, px: 3, background: 'background.paper' }}>
          ...
          <Box sx={{ textAlign: 'center', mb: 16 }}>
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <Typography variant="h2" sx={{ 
                fontWeight: 900, mt: 3, color: 'primary.900',
              ...
              >
                ...
                >
                  <Box sx={{ 
                    ...
                    <Box sx={{ 
                      width: 80, height: 80, borderRadius: '50%', background: 'background.paper',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      mx: 'auto', mb: 4, color: 'primary.900', border: '2px solid #e2e8f0',
                    ...
                    <Typography variant="h5" sx={{ fontWeight: 900, mb: 2, color: 'primary.900', fontSize: '1.4rem', letterSpacing: '-0.02em' }}>
                      {step.title}
                    </Typography>
                    <Typography variant="body1" sx={{ color: 'text.secondary', fontSize: '1rem', lineHeight: 1.6, maxWidth: '20ch', mx: 'auto' }}>
                      {step.desc}
                    </Typography>
                  </Box>
                </motion.div>
