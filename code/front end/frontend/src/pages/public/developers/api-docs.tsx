...
export default function APIDocs() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', background: 'background.paper', overflowX: 'hidden' }}>
              ...
              <Grid size={{ xs: 12, md: 10 }} >
                ...
                <Typography 
                  ...
                  sx={{ 
                    ...
                    lineHeight: 1.1, color: 'primary.900'
                  }}
                >
                ...
                <Typography 
                  variant="h5" 
                  sx={{ 
                    color: 'text.secondary', lineHeight: 1.7, fontWeight: 400, 
            ...
            <Grid container spacing={8} alignItems="center">
              <Grid size={{ xs: 12, md: 5 }} >
                <motion.div variants={fadeUp}>
                  ...
                  <Typography variant="body1" sx={{ color: 'text.secondary', fontSize: '1.25rem', lineHeight: 1.8, mb: 4 }}>
                ...
                <motion.div variants={fadeUp}>
                  <Box sx={{ 
                    ...
                    <Box sx={{ textAlign: 'center', flex: 1 }}>
                      <Box sx={{ width: 80, height: 80, mx: 'auto', background: 'background.paper', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #e2e8f0', mb: 2, boxShadow: '0 10px 30px rgba(0,0,0,0.03)' }}>
                        <Database size={32} color='text.primary' />
                      </Box>
                      <Typography variant="h6" sx={{ fontWeight: 700, color: 'text.primary' }}>{t('api_docs.hospital_sys')}</Typography>
                      <Typography variant="body2" sx={{ color: 'text.secondary' }}>{t('api_docs.hospital_sub')}</Typography>
                    </Box>
                    ...
                    <Box sx={{ textAlign: 'center', flex: 1 }}>
                      <Box sx={{ position: 'relative', width: 80, height: 80, mx: 'auto', mb: 2 }}>
                        ...
                        />
                        <Box sx={{ position: 'relative', width: '100%', height: '100%', background: 'primary.900', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 10px 30px rgba(6, 78, 59, 0.2)', zIndex: 1 }}>
                          <Network size={32} color='background.paper' />
                        </Box>
                      </Box>
                      <Typography variant="h6" sx={{ fontWeight: 700, color: 'primary.900' }}>{t('api_docs.ai_sys')}</Typography>
      ...
      <Box sx={{ background: 'background.default', py: { xs: 12, md: 20 }, px: 3 }}>
        <Container maxWidth="xl">
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      {/* CTA Section */}
      <Box sx={{ background: 'primary.900', color: 'background.paper', py: { xs: 12, md: 16 }, px: 3, textAlign: 'center' }}>
        <Container maxWidth="md">
          ...
          >
            ...
            <Button 
              variant="contained" 
              sx={{ 
                background: '#08bba3', color: 'background.paper', 
