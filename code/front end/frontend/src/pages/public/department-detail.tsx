      ...
      <Box sx={{ minHeight: '100vh', bgcolor: 'background.default', pb: 10 }}>
        ...
        >
          <Container maxWidth="xl">
            <Skeleton variant="text" width={220} height={30} sx={{ bgcolor: 'color-mix(in srgb, var(--color-surface-50) 25%, transparent)', mb: 2 }} />
            <Skeleton variant="text" width="55%" height={72} sx={{ bgcolor: 'color-mix(in srgb, var(--color-surface-50) 30%, transparent)', mb: 2 }} />
            <Skeleton variant="text" width="40%" height={38} sx={{ bgcolor: 'color-mix(in srgb, var(--color-surface-50) 20%, transparent)' }} />
          </Container>
        </Box>
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: 'background.default', pb: 10 }}>
      ...
      <Box sx={{ 
        ...
        <Container maxWidth="xl">
          <Breadcrumbs aria-label="breadcrumb" sx={{ color: 'color-mix(in srgb, var(--color-surface-50) 70%, transparent)', mb: 3 }}>
            ...
            <Typography sx={{ color: 'background.paper' }}>{department.name}</Typography>
          </Breadcrumbs>
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid size={{ xs: 12, md: 4 }} sx={{ textAlign: { md: 'right' } }}>
              <Box sx={{ 
                p: 3, bgcolor: 'color-mix(in srgb, var(--color-surface-50) 10%, transparent)', borderRadius: 1, 
                backdropFilter: 'blur(10px)', border: '1px solid color-mix(in srgb, var(--color-surface-50) 20%, transparent)' 
              }}>
                <LocalHospital sx={{ fontSize: 60, mb: 1, color: 'primary.main' }} />
        ...
        <Grid container spacing={5}>
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            <Paper elevation={0} sx={{ p: { xs: 3, md: 5 }, borderRadius: 2, mb: 4 }}>
              <Typography variant="h4" sx={{ fontWeight: 800, color: 'primary.900', mb: 3 }}>Giới thiệu chuyên khoa</Typography>
            ...
            <Typography variant="h4" sx={{ fontWeight: 800, color: 'primary.900', mb: 3, mt: 6 }}>Đội ngũ bác sĩ thuộc khoa</Typography>
                  ...
                  <Paper sx={{ 
                    ...
                    <Stack direction="row" spacing={2.5} alignItems="center">
                      ...
                      <Box>
                        ...
                        <Stack direction="row" spacing={0.5} sx={{ color: 'var(--color-warning)' }}>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            <Stack spacing={4}>
              {/* Quick Booking */}
              <Paper sx={{ p: 4, borderRadius: 2, bgcolor: 'primary.900', color: 'background.paper' }}>
                ...
                <Button 
                  ...
                  sx={{ 
                    bgcolor: 'primary.main', color: 'background.paper', py: 1.5, borderRadius: 3, 
                    fontWeight: 800, '&:hover': { bgcolor: 'primary.dark' } 
                  }}
                >
                  Đăng ký khám ngay
                </Button>
              ...
              <Paper sx={{ p: 4, borderRadius: 2 }}>
                ...
                <List spacing={2}>
                  ...
                  <ListItem disableGutters>
                    <ListItemIcon><AccessTime sx={{ color: 'primary.dark' }} /></ListItemIcon>
                    <ListItemText primary="Giờ làm việc" secondary="Thứ 2 - Thứ 7 (7:30 - 17:30)" />
                  </ListItem>
                  <ListItem disableGutters>
                    <ListItemIcon><LocationOn sx={{ color: 'primary.dark' }} /></ListItemIcon>
