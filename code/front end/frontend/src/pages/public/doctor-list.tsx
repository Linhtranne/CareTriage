      ...
      >
          ...
          <Box sx={{ mt: 3, display: 'flex', flexWrap: 'wrap', gap: 1.5 }}>
            {doctor.departments?.map((dept) => (
              <Box 
                ...
                sx={{ 
                  px: 2.5, py: 0.75, 
                  background: 'background.paper', color: 'text.secondary',
        ...
        <Box sx={{ 
          ...
          <Box sx={{ textAlign: { xs: 'left', md: 'right' } }}>
            ...
            <Typography variant="h3" sx={{ fontWeight: 900, color: 'primary.900' }}>
          ...
          <Button 
            variant="contained" 
            sx={{ 
              background: 'text.primary', color: 'background.paper',
              borderRadius: '100px', 
              px: 5, py: 2, 
...
export default function DoctorList() {
  ...
  return (
    <Box sx={{ bgcolor: 'background.paper', minHeight: '100vh' }}>
      ...
      <Box sx={{ background: 'background.default', pt: { xs: 16, md: 24 }, pb: { xs: 12, md: 16 }, px: 3, borderBottom: '1px solid #e2e8f0' }}>
          ...
          >
            <Grid container>
              <Grid size={{ xs: 12, md: 9, lg: 8 }} >
                ...
                <Typography variant="h1" sx={{ fontWeight: 900, mb: 3, letterSpacing: '-0.03em', fontSize: { xs: '3rem', md: '5rem' }, color: 'primary.900', lineHeight: 1.1 }}>
                  {t('doctor_list.hero_title_1')} <br />
                  {t('doctor_list.hero_title_2')}
                </Typography>
                <Typography variant="body1" sx={{ color: 'text.secondary', fontSize: '1.25rem', maxWidth: '55ch', lineHeight: 1.7 }}>
      ...
      <Box sx={{ borderBottom: '1px solid #e2e8f0', background: 'background.paper', py: 4 }}>
        <Container maxWidth="xl">
              ...
              <Box sx={{ 
                ...
                <Chip
                  ...
                  sx={{ 
                    ...
                    background: filters.departmentId === '' ? 'rgba(8, 187, 163, 0.1)' : 'background.paper',
                    color: filters.departmentId === '' ? 'primary.900' : 'text.secondary',
                    '&:hover': { background: filters.departmentId === '' ? 'rgba(8, 187, 163, 0.15)' : 'background.default' }
                  }}
                />
                {departments.map((dept) => (
                  <Chip
                    ...
                    sx={{ 
                      ...
                      background: filters.departmentId === dept.id ? 'rgba(8, 187, 163, 0.1)' : 'background.paper',
                      color: filters.departmentId === dept.id ? 'primary.900' : 'text.secondary',
                      '&:hover': { background: filters.departmentId === dept.id ? 'rgba(8, 187, 163, 0.15)' : 'background.default' }
                    }}
                  />
                ))}
              </Box>
                ...
                {(filters.departmentId || filters.search) && (
                  <Button
                    ...
                    sx={{ 
                      ...
                      color: 'text.secondary', border: '1px solid #e2e8f0',
                      '&:hover': { background: '#f1f5f9', color: 'text.primary', borderColor: '#cbd5e1' }
                    }}
                  >
                    <X size={20} />
                  </Button>
          ...
          {loading ? (
            ...
            <motion.div key="empty" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <Box sx={{ 
                ...
                <Typography color='text.secondary' sx={{ mb: 4, fontSize: '1.25rem' }}>
                ...
                <Button 
                  ...
                  sx={{ 
                    ...
                    borderWidth: '2px',
                    '&:hover': { borderWidth: '2px', background: 'text.primary', color: 'background.paper' }
                  }}
                >
