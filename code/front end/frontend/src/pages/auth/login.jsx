          ...
          <CardContent sx={{ p: { xs: 3, md: 4.5 } }}>
            <Box sx={{ mb: 3 }}>
              <Typography variant="h4" sx={{ fontWeight: 900, color: '#064e3b', textTransform: 'uppercase', mb: 0.5, letterSpacing: '-0.02em' }}>
                {requires2FA ? 'Xác thực 2 bước' : tTitle}
              </Typography>
              <Typography variant="body2" sx={{ color: '#4b5563', fontWeight: 500 }}>
                {requires2FA ? 'Vui lòng kiểm tra email của bạn và nhập mã xác thực OTP gồm 6 chữ số' : tSubtitle}
              </Typography>
            </Box>
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              ...
              >
                {isLoading ? <CircularProgress size={24} color="inherit" /> : (requires2FA ? 'XÁC NHẬN MÃ' : tBtn)}
              </Button>
            </Box>
