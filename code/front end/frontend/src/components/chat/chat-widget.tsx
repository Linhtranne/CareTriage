        ...
        {!isOpen && (
          ...
          >
            <button
              ...
              className="w-14 h-14 rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 text-white flex items-center justify-center shadow-[0_8px_32px_color-mix(in srgb, var(--color-primary-500) 40%, transparent)] hover:shadow-[0_12px_40px_color-mix(in srgb, var(--color-primary-500) 50%, transparent)] hover:scale-110 active:scale-95 transition-all duration-200"
            >
