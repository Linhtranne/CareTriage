          ...
          {userMessageCount >= 2 && !isEmergency && !isCompletingTriage && !missingInfo && !showSuccessOverlay && (
            ...
            >
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-[11px] font-extrabold shadow-[0_4px_12px_rgba(16,185,129,0.2)] hover:scale-[1.03] active:scale-95 transition-all duration-200"
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-2.5 w-full max-w-[240px]">
                    <button
                      ...
                      className="w-full py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-bold text-[13px] shadow-[0_4px_16px_rgba(16,185,129,0.25)] transition-all duration-200"
                    >
                      Xem phiếu tư vấn
                    </button>
                    <button
