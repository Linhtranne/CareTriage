...
const SHELL_SURFACE = {
  ...
  badgeBorder: '1px solid var(--color-surface-200)',
  badgeBackground: 'var(--color-surface-100)',
...
export default function DoctorPageShell({
  ...
  const badgeLabel = badge ?? t('doctor_shell.badge')
          ...
          <Stack spacing={SHELL_LAYOUT.stackSpacing}>
            <Box
              sx={{
                ...
                border: SHELL_SURFACE.badgeBorder,
              }}
            >
              {badgeLabel}
            </Box>
