/* eslint-disable no-magic-numbers, project-rules/no-hardcoded-color, project-rules/no-hardcoded-text, @typescript-eslint/no-explicit-any */
...
const STATUS_META = {
  ...
  CANCELLED: { label: 'Đã hủy', color: '#eb5a67' },
  ...
  return (
    <Paper
      sx={{
        ...
        position: 'relative',
        overflow: 'hidden',
        background: 'linear-gradient(180deg, color-mix(in srgb, #f8fafc 92%, transparent) 0%, rgba(248,250,252,0.9) 100%)',
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Paper
        sx={{
          p: 3,
          borderRadius: 4,
          background: 'linear-gradient(135deg, color-mix(in srgb, #f8fafc 96%, transparent) 0%, rgba(248,250,252,0.92) 100%)',
        ...
        <Grid xs={12} lg={8}>
          <Paper
            sx={{
              ...
              height: '100%',
              borderRadius: 4,
              background: 'linear-gradient(180deg, color-mix(in srgb, #f8fafc 96%, transparent) 0%, rgba(248,250,252,0.92) 100%)',
      ...
      <Paper
        sx={{
          p: 2.5,
          borderRadius: 4,
          background: 'linear-gradient(135deg, color-mix(in srgb, #00b48e 8%, transparent) 0%, color-mix(in srgb, #f8fafc 92%, transparent) 100%)',
