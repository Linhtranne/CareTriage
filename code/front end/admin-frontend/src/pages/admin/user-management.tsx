...
export default function UserManagement() {
  ...
  // Dialog states
  const [roleDialog, setRoleDialog] = useState<UserDialogState>({ open: false, user: null })
  const [toggleDialog, setToggleDialog] = useState<UserDialogState>({ open: false, user: null })
  const [detailDialog, setDetailDialog] = useState<UserDialogState>({ open: false, user: null })
  const [editDialog, setEditDialog] = useState<UserDialogState>({ open: false, user: null })
          ...
          <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} sx={{ alignItems: 'center' }}>
            ...
            <Stack direction="row" spacing={2} sx={{ alignItems: 'center' }}>
              ...
              <ToggleButtonGroup
                ...
                size="small"
                sx={{
                  bgcolor: 'color-mix(in srgb, #f8fafc 40%, transparent)',
                  borderRadius: '12px',
                  p: 0.5,
